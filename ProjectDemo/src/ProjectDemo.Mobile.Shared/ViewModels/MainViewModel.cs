...
using ProjectDemo.Authorization.Users.Profile.Dto;
using ProjectDemo.Commands;
using ProjectDemo.Core.Threading;
using ProjectDemo.Models.NavigationMenu;
using ProjectDemo.Services.Navigation;
using ProjectDemo.ViewModels.Base;
using Plugin.Media;
...
using ProjectDemo.ApiClient;
using ProjectDemo.Controls;
using ProjectDemo.Dto;
using ProjectDemo.Extensions;
using ProjectDemo.Localization;
using ProjectDemo.UI;
using ProjectDemo.UI.Assets;
using ProjectDemo.Views;
using DependencyResolver = ProjectDemo.Core.Dependency.DependencyResolver;
...
namespace ProjectDemo.ViewModels
{
    public class MainViewModel : XamarinViewModel
    {
        ...
        private const string ApplicationName = "ProjectDemo";
