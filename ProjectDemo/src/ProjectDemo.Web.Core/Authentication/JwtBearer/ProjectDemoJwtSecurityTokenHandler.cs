...
namespace ProjectDemo.Web.Authentication.JwtBearer
{
    public class ProjectDemoJwtSecurityTokenHandler : ISecurityTokenValidator
    {
        private readonly JwtSecurityTokenHandler _tokenHandler;

        public ProjectDemoJwtSecurityTokenHandler()
        {
