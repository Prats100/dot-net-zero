...
using ProjectDemo.DashboardCustomization.Dto;
using ProjectDemo.Web.Areas.App.Models.CustomizableDashboard;
...
{
    public abstract class CustomizableDashboardControllerBase : ProjectDemoControllerBase
    {
        ...
        protected async Task<ActionResult> GetView(string dashboardName)
        {
            var dashboardDefinition = DashboardCustomizationAppService.GetDashboardDefinition(
                ...
                {
                    DashboardName = dashboardName,
                    Application = ProjectDemoDashboardCustomizationConsts.Applications.Mvc
                }
            );
