...
using ProjectDemo.Configuration.Host;
using ProjectDemo.Editions;
using ProjectDemo.Timing;
using ProjectDemo.Timing.Dto;
using ProjectDemo.Web.Areas.App.Models.HostSettings;
...
namespace ProjectDemo.Web.Areas.App.Controllers
{
    ...
    public class HostSettingsController : ProjectDemoControllerBase
    {
