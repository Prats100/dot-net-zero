...
using ProjectDemo.Identity;
using ProjectDemo.Schemas;
using ProjectDemo.Web.Chat.SignalR;
using ProjectDemo.Web.Common;
using ProjectDemo.Web.Resources;
using Swashbuckle.AspNetCore.Swagger;
using ProjectDemo.Web.IdentityServer;
using ProjectDemo.Web.Swagger;
using Stripe;
...
using ProjectDemo.Web.HealthCheck;
using Owl.reCAPTCHA;
using HealthChecksUISettings = HealthChecks.UI.Configuration.Settings;
using Microsoft.AspNetCore.Server.Kestrel.Https;
using Microsoft.Extensions.DependencyInjection.Extensions;
using SecurityStampValidatorCallback = ProjectDemo.Identity.SecurityStampValidatorCallback;
...
namespace ProjectDemo.Web.Startup
{
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            ...
            return services.AddAbp<ProjectDemoWebMvcModule>(options =>
            {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            if (WebConsts.SwaggerUiEnabled)
            {
                ...
                {
                    options.SwaggerEndpoint(_appConfiguration["App:SwaggerEndPoint"], "ProjectDemo API V1");
                    options.IndexStream = () => Assembly.GetExecutingAssembly()
                        .GetManifestResourceStream("ProjectDemo.Web.wwwroot.swagger.ui.index.html");
        ...
        private void ConfigureSwagger(IServiceCollection services)
        {
            ...
            {
                options.SwaggerDoc("v1", new OpenApiInfo() {Title = "ProjectDemo API", Version = "v1"});
                ...
                var applicationXml = $"ProjectDemo.Application.xml";
                var applicationXmlPath = Path.Combine(AppContext.BaseDirectory, applicationXml);
                options.IncludeXmlComments(applicationXmlPath);

                var webCoreXmlFile = $"ProjectDemo.Web.Core.xml";
