...
using ProjectDemo.Web.Startup.ExternalLoginInfoProviders;
...
namespace ProjectDemo.Web.Startup
{
    ...
    public class ProjectDemoWebHostModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public ProjectDemoWebHostModule(
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(ProjectDemoWebHostModule).GetAssembly());
        }
