...
using ProjectDemo.Core.Base;
using ProjectDemo.Core.Extensions;
using ProjectDemo.Dto;
using ProjectDemo.Types;

namespace ProjectDemo.Queries
{
    public class OrganizationUnitQuery : ProjectDemoQueryBase<ListGraphType<OrganizationUnitType>, List<OrganizationUnitDto>>
    {
