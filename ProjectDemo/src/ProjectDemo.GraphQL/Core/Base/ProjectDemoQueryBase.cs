...
namespace ProjectDemo.Core.Base
{
    public abstract class ProjectDemoQueryBase<TField,TResult> : ITransientDependency
    {
        ...
        protected ProjectDemoQueryBase(string fieldName,
