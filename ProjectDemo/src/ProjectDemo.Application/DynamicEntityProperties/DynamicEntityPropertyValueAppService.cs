...
using ProjectDemo.DynamicEntityPropertyValues.Dto;

namespace ProjectDemo.DynamicEntityProperties
{
    [AbpAuthorize(AppPermissions.Pages_Administration_DynamicEntityPropertyValue)]
    public class DynamicEntityPropertyValueAppService : ProjectDemoAppServiceBase, IDynamicEntityPropertyValueAppService
    {
