...
using ProjectDemo.Auditing.Exporting;
using ProjectDemo.Authorization;
using ProjectDemo.Authorization.Users;
using ProjectDemo.Dto;
using ProjectDemo.EntityHistory;
using EntityHistoryHelper = ProjectDemo.EntityHistory.EntityHistoryHelper;

namespace ProjectDemo.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : ProjectDemoAppServiceBase, IAuditLogAppService
    {
