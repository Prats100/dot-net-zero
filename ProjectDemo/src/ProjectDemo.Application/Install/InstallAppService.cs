...
namespace ProjectDemo.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : ProjectDemoAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<ProjectDemoDbContext> _migrator;
        ...
        {
            EditAppSettingsjson($"ConnectionStrings:{ProjectDemoConsts.ConnectionStringName}", constring);
        }
