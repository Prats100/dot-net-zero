...
{
    public class SessionAppService : ProjectDemoAppServiceBase, ISessionAppService
    {
            ...
            return await _unitOfWorkManager.WithUnitOfWorkAsync(async () =>
            {
                var output = new GetCurrentLoginInformationsOutput
                {
                    Application = new ApplicationInfoDto
                    {
                        ...
                        Currency = ProjectDemoConsts.Currency,
                        CurrencySign = ProjectDemoConsts.CurrencySign,
                        AllowTenantsToChangeEmailSettings = ProjectDemoConsts.AllowTenantsToChangeEmailSettings,
