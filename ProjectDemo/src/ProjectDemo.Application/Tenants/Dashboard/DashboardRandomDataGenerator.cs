...
using ProjectDemo.Tenants.Dashboard.Dto;

namespace ProjectDemo.Tenants.Dashboard
{
    public static class DashboardRandomDataGenerator
    {
        ...
        public static List<MemberActivity> GenerateMemberActivities()
        {
            ...
            {
                new MemberActivity("Brain", ProjectDemoConsts.CurrencySign + GetRandomInt(100, 500), GetRandomInt(10, 100), GetRandomInt(10, 150),
                    GetRandomInt(10, 99) + "%"),

                new MemberActivity("Jane", ProjectDemoConsts.CurrencySign + GetRandomInt(100, 500), GetRandomInt(10, 100), GetRandomInt(10, 150),
                    GetRandomInt(10, 99) + "%"),

                new MemberActivity("Tim", ProjectDemoConsts.CurrencySign + GetRandomInt(100, 500), GetRandomInt(10, 100), GetRandomInt(10, 150),
                    GetRandomInt(10, 99) + "%"),

                new MemberActivity("Kate", ProjectDemoConsts.CurrencySign + GetRandomInt(100, 500), GetRandomInt(10, 100), GetRandomInt(10, 150),
                    GetRandomInt(10, 99) + "%")
            };
        }
