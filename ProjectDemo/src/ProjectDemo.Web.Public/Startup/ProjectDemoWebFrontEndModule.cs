...
namespace ProjectDemo.Web.Public.Startup
{
    [DependsOn(
        typeof(ProjectDemoWebCoreModule)
    )]
    public class ProjectDemoWebFrontEndModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public ProjectDemoWebFrontEndModule(IWebHostEnvironment env, ProjectDemoEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(ProjectDemoWebFrontEndModule).GetAssembly());
        }
    }
}
