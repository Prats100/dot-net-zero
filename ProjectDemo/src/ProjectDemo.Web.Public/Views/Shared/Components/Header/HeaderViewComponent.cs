...
using ProjectDemo.Web.Public.Startup;
using ProjectDemo.Web.Session;

namespace ProjectDemo.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : ProjectDemoViewComponent
    {
