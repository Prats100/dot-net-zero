...
{
    public class SubscriptionPaymentRepository : ProjectDemoRepositoryBase<SubscriptionPayment, long>, ISubscriptionPaymentRepository
    {
        public SubscriptionPaymentRepository(IDbContextProvider<ProjectDemoDbContext> dbContextProvider)
