...
using ProjectDemo.EntityFrameworkCore.Repositories;

namespace ProjectDemo.MultiTenancy.Payments
{
    public class SubscriptionPaymentExtensionDataRepository : ProjectDemoRepositoryBase<SubscriptionPaymentExtensionData, long>,
        ISubscriptionPaymentExtensionDataRepository
    {
        public SubscriptionPaymentExtensionDataRepository(IDbContextProvider<ProjectDemoDbContext> dbContextProvider) : base(dbContextProvider)
        {
        }
