...
using ProjectDemo.Authorization.Ldap;
...
using ProjectDemo.DashboardCustomization.Definitions;
using ProjectDemo.Debugging;
using ProjectDemo.DynamicEntityProperties;
using ProjectDemo.Features;
using ProjectDemo.Friendships;
using ProjectDemo.Friendships.Cache;
using ProjectDemo.Localization;
using ProjectDemo.MultiTenancy;
using ProjectDemo.Net.Emailing;
using ProjectDemo.Notifications;
using ProjectDemo.WebHooks;
using Newtonsoft.Json;

namespace ProjectDemo
{
    [DependsOn(
        typeof(ProjectDemoCoreSharedModule),
        typeof(AbpZeroCoreModule),
        typeof(AbpZeroLdapModule),
        typeof(AbpAutoMapperModule),
        typeof(AbpAspNetZeroCoreModule),
        typeof(AbpMailKitModule))]
    public class ProjectDemoCoreModule : AbpModule
    {
        public override void PreInitialize()
        {
            ...
            ProjectDemoLocalizationConfigurer.Configure(Configuration.Localization);
            ...
            Configuration.MultiTenancy.IsEnabled = ProjectDemoConsts.MultiTenancyEnabled;
            ...
            Configuration.ReplaceService<IMailKitSmtpBuilder, ProjectDemoMailKitSmtpBuilder>(DependencyLifeStyle.Transient);
            ...
            Configuration.ReplaceService(typeof(IEmailSenderConfiguration), () =>
            {
                Configuration.IocManager.IocContainer.Register(
                    Component.For<IEmailSenderConfiguration, ISmtpEmailSenderConfiguration>()
                             .ImplementedBy<ProjectDemoSmtpEmailSenderConfiguration>()
                             .LifestyleTransient()
                );
            });
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(ProjectDemoCoreModule).GetAssembly());
        }
