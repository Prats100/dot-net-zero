...
namespace ProjectDemo.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : ProjectDemoServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("ProjectDemo", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
