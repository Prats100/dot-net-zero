...
{
    public class StripeGatewayManager : ProjectDemoServiceBase,
        ...
        ITransientDependency
    {
        ...
        public static string ProductName = "ProjectDemo";
        ...
        {
            return editionName + "_" + paymentPeriodType + "_" + ProjectDemoConsts.Currency;
        }
