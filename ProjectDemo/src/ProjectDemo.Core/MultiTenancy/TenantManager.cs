...
using ProjectDemo.MultiTenancy.Demo;
...
namespace ProjectDemo.MultiTenancy
{
    ...
    public class TenantManager : AbpTenantManager<Tenant, User>
    {
            ...
            string emailActivationLink)
        {
            ...
            {
                throw new UserFriendlyException(LocalizationManager.GetString(ProjectDemoConsts.LocalizationSourceName, "TrialWithoutEndDateErrorMessage"));
            }
        ...
        public async Task CheckEditionAsync(int? editionId, bool isInTrialPeriod)
        {
            ...
            var error = LocalizationManager.GetSource(ProjectDemoConsts.LocalizationSourceName).GetString("FreeEditionsCannotHaveTrialVersions");
