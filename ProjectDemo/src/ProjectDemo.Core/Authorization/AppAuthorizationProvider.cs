...
namespace ProjectDemo.Authorization
{
    ...
    public class AppAuthorizationProvider : AuthorizationProvider
    {
        ...
        public override void SetPermissions(IPermissionDefinitionContext context)
        {
            ...
            pages.CreateChildPermission(AppPermissions.Pages_Tenant_PhoneBook_CreatePerson, L("CreateNewPerson"), multiTenancySides: MultiTenancySides.Tenant);


            pages.CreateChildPermission(AppPermissions.Pages_Tenant_PhoneBook_DeletePerson, L("PhoneBook"), multiTenancySides: MultiTenancySides.Tenant);
        ...
        {
            return new LocalizableString(name, ProjectDemoConsts.LocalizationSourceName);
        }
    }
}
