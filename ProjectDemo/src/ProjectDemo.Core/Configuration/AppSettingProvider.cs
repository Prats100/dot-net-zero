...
using ProjectDemo.Authentication;
...
namespace ProjectDemo.Configuration
{
    ...
    public class AppSettingProvider : SettingProvider
    {
        ...
        {
            if (!ProjectDemoConsts.AllowTenantsToChangeEmailSettings)
            {
            ...
            return new[]
            {
                ...
                new SettingDefinition(AppSettings.Email.UseHostDefaultEmailSettings,
                    GetFromAppSettings(AppSettings.Email.UseHostDefaultEmailSettings,
                        ProjectDemoConsts.MultiTenancyEnabled ? "true" : "false"), scopes: SettingScopes.Tenant)
            };
        }
        ...
        private IEnumerable<SettingDefinition> GetDashboardSettings()
        {
            ...
            return new[]
            {
                new SettingDefinition(
                    ...
                    ProjectDemoDashboardCustomizationConsts.Applications.Mvc, mvcDefaultSettingsJson,
                    scopes: SettingScopes.All, clientVisibilityProvider: _visibleSettingClientVisibilityProvider),
                new SettingDefinition(
                    AppSettings.DashboardCustomization.Configuration + "." +
                    ProjectDemoDashboardCustomizationConsts.Applications.Angular, angularDefaultSettingsJson,
                    scopes: SettingScopes.All, clientVisibilityProvider: _visibleSettingClientVisibilityProvider)
            };
        }
        ...
        public List<Dashboard> GetDefaultMvcDashboardViews()
        {
            ...
            return new List<Dashboard>
            {
                new Dashboard
                {
                    DashboardName = ProjectDemoDashboardCustomizationConsts.DashboardNames.DefaultTenantDashboard,
                    Pages = new List<Page>
                    {
                        new Page
                        {
                            Name = ProjectDemoDashboardCustomizationConsts.DefaultPageName,
                            Widgets = new List<Widget>
                            {
                                new Widget
                                {
                                    WidgetId = ProjectDemoDashboardCustomizationConsts.Widgets.Tenant
                                ...
                                {
                                    WidgetId =
                                        ProjectDemoDashboardCustomizationConsts.Widgets.Tenant
                ...
                new Dashboard
                {
                    DashboardName = ProjectDemoDashboardCustomizationConsts.DashboardNames.DefaultHostDashboard,
                    Pages = new List<Page>
                    {
                        new Page
                        {
                            ...
                            Widgets = new List<Widget>
                            {
                                new Widget
                                {
                                    WidgetId = ProjectDemoDashboardCustomizationConsts.Widgets.Host
                                        .TopStats, // Top Stats
                                    Height = 6,
                                    Width = 12,
                                    PositionX = 0,
                                ...
                                {
                                    WidgetId =
                                        ProjectDemoDashboardCustomizationConsts.Widgets.Host
