...
$webMvcFolder = Join-Path $slnFolder "src/ProjectDemo.Web.Mvc"
$webPublicFolder = Join-Path $slnFolder "src/ProjectDemo.Web.Public"
...
dotnet restore ProjectDemo.Web.sln
