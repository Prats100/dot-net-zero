...
using ProjectDemo.MultiTenancy.HostDashboard;
...
namespace ProjectDemo.Tests.HostDashboard
{
    ...
    public class HostDashboardAppService_Tests : AppTestBase
    {
        ...
        private void CreatePaidPayment(ProjectDemoDbContext context, SubscriptionPayment subscriptionPayment)
        {
